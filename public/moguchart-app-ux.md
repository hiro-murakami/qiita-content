...
発端は [moguchart-core](https://github.com/mogura-org/moguchart-core) を作ったことでした。
割とあっさり形になってしまったことで、次はどうしようか...と考えていたときに、バックエンドも作ってWebアプリにすれば、コアライブラリのデモにもなるし、世の中には使ってくれる人もいるかもしれない...と思い、作ってみることにしました。  
業務でFirebaseを使ったWebアプリの作成経験があったので、それを活かしつつ新しい技術を学ぶ良い機会になると考えました。
