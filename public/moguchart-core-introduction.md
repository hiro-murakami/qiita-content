...
tags:
  ...
  - ガントチャート
private: true
updated_at: '2026-05-24T14:24:13+09:00'
...
遡ること数年前、業務でガントチャートを表示するWebアプリを作りました。
既存のガントチャートライブラリを調査したのですが、要件に合うものが見つからなかったため、ほぼフルスクラッチで開発しました。
その頃からnpmライブラリとして公開することを構想していましたが、なかなか着手できずにいた2025年の年末、AIを使うとできるんじゃね？と思い立ち、やってみると数日で基本部分が出来てしまいました。（以前作ったガントチャートのコードとは全く関連はありません）
作ってみるとライブラリだけでは物足りなくなって、Webアプリの方も作ったりして今に至ります。
...
https://qiita.com/hiro-murakami/private/bfdaf141de040cb387b9
